...
projectBoardSchema.methods.reorderColumns = function(this: IProjectBoard, newOrder: string[]) {
...
export const ProjectBoard = mongoose.model<IProjectBoard>('ProjectBoard', projectBoardSchema); 
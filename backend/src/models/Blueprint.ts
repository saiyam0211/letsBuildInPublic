...
const blueprintMetadataSchema = new Schema<IBlueprintMetadata>({
  ...
  estimatedTimeline: {
    ...
    trim: true,
    enum: {
      values: ['1-2 weeks', '3-4 weeks', '1-2 months', '3-6 months', '6-12 months', '12+ months'],
...
blueprintSchema.methods.getCompletionPercentage = function(this: IBlueprint): number {
...
blueprintSchema.methods.generateShareLink = function(this: IBlueprint): string {
